/*
 * Copyright (C) 2009 Double Sunflower Holdings Inc.
 *
...
import com.doublesunflower.core.ui.maps.LockCast;
 ...
 * a particular location. All of the work is done on a separate thread, and progress
...
public class ImageManager {
   private static final String TAG = "doublesunflower";
     ...
     */
    private ArrayList<PamoramioItem> mImages = new ArrayList<PamoramioItem>();
    ...
    public static String halfspan = "10000";
     ...
     */
    private void add(PamoramioItem item) {
        mImages.add(item);   
        notifyObservers();
    }
     ...
     */
    public PamoramioItem get(int position) {
        ...
        private void parse(JSONObject json) {
            try {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    final PamoramioItem item = new PamoramioItem(id, thumb, b,
                            (int) (latitude * LockCast.MILLION),
                            (int) (longitude * LockCast.MILLION), title, owner,
                            ownerUrl, photoUrl);
