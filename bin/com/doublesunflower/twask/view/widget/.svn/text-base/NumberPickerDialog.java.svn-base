...
public class NumberPickerDialog extends AlertDialog implements OnClickListener {
    ...
    public interface OnNumberPickedListener {
        void onNumberPicked(NumberPickerControlSet view, int number);
    }

    private final NumberPickerControlSet           mPicker;
    ...
    public NumberPickerDialog(Context context, OnNumberPickedListener callBack,
        ...
        setTitle(title);
        mPicker = (NumberPickerControlSet) view.findViewById(R.id.numberPicker);
