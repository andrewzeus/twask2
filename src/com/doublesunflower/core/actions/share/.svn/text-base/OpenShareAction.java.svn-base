package com.doublesunflower.core.actions.share;
...
public class OpenShareAction extends AbstractAction {

	@Override
	public Object perform(Activity activity, Object params) throws BusinessException {
		try{
			Intent i = new Intent();
			i.setClassName( "com.doublesunflower", "com.doublesunflower.core.ui.share.ShareActivity" );
