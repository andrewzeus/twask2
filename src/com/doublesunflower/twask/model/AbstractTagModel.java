...
public abstract class AbstractTagModel extends AbstractModel {
    ...
    public static class TagModelDatabaseHelper extends SQLiteOpenHelper {
        String tableName;

        public TagModelDatabaseHelper(Context context, String databaseName, String tableName) {
    ...
    public void setTagIdentifier(TagIdentifier identifier) {
