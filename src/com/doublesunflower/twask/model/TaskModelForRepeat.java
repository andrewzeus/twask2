...
import com.doublesunflower.twask.receiver.NotificationsReceiver.Notifiable;
...
public class TaskModelForRepeat extends AbstractTaskModel implements Notifiable {
    ...
    public void repeatTaskBy(Context context, TaskController taskController,
        ...
        NotificationsReceiver.updateAlarm(context, taskController, alertController, this);
