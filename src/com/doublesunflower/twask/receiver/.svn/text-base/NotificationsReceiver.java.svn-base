...
import com.doublesunflower.twask.view.activities.TwaskNotify;
...
public class NotificationsReceiver extends BroadcastReceiver {
    ...
    public static boolean showNotification(Context context, long id,
        ...
        try {
            ...
            Log.e(NotificationsReceiver.class.getSimpleName(),
        ...
        Intent notifyIntent = new Intent(context, TwaskNotify.class);
        notifyIntent.putExtra(TwaskListSubActivity.LOAD_INSTANCE_TOKEN, id);
        notifyIntent.putExtra(TwaskListSubActivity.FROM_NOTIFICATION_TOKEN, true);
        notifyIntent.putExtra(TwaskListSubActivity.NOTIF_FLAGS_TOKEN, flags);
        notifyIntent.putExtra(TwaskListSubActivity.NOTIF_REPEAT_TOKEN, repeatInterval);
    ...
    public static boolean showTimingNotification(Context context,
        ...
        Intent notifyIntent = new Intent(context, TwaskNotify.class);
        notifyIntent.putExtra(TwaskListSubActivity.LOAD_INSTANCE_TOKEN, taskId.getId());
        notifyIntent.putExtra(TwaskListSubActivity.FROM_NOTIFICATION_TOKEN, true);
        PendingIntent pendingIntent = PendingIntent.getActivity(context,
        ...
        Log.w("Twask", "Logging timing notification: " + text);
