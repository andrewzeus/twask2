...
/*
import com.doublesunflower.android.location.BreadCrumbService;
import com.doublesunflower.android.location.ViewMap;
import com.doublesunflower.android.lockcast.LockcastItem;
import com.doublesunflower.android.lockcast.R;
import com.doublesunflower.android.lockcast.R.drawable;
import com.doublesunflower.android.lockcast.R.id;
import com.doublesunflower.android.lockcast.R.layout;
...
public class ViewImage extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_STOP: {
        	//stopService(new Intent(ViewImage.this,
            ...
            try {
                ...
                mHandler.post(new Runnable() {
                    public void run() {
                        ...
                        mTitle.setText("Andrew Xu collection");
                        mOwner.setText("Andrew Xu");
