...
public class NumberPickerControlSet extends LinearLayout implements OnClickListener,
        OnFocusChangeListener, OnLongClickListener {

    public interface OnChangedListener {
        void onChanged(NumberPickerControlSet picker, int oldVal, int newVal);
    }
     ...
     * format().
     */
    public static final NumberPickerControlSet.Formatter TWO_DIGIT_FORMATTER = new NumberPickerControlSet.Formatter() {
    ...
    public NumberPickerControlSet(Context context) {
        this(context, null);
    }

    public NumberPickerControlSet(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NumberPickerControlSet(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
